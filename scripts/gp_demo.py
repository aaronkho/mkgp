...
GPR.set_error_kernel(kernel=nkernel,kbounds=nkbounds,regpar=10.0,epsilon=1.0e-1)
...
NIGPR.set_error_kernel(kernel=nkernel,kbounds=nkbounds,regpar=10.0,epsilon=1.0e-1)
