...
# Data generation - not real fusion data!
...
#GPR.set_error_search_parameters(epsilon=1.0e-1,method='adam')
...
#NIGPR.set_error_search_parameters(epsilon=1.0e-1,method='adam')
