...
def linear_test_data():
    ...
    xy_mean = np.array([-1.80429463, -1.68437296, -1.56445130, -1.44452963, -1.32460796,
                        -1.20468629, -1.08476463, -0.96484296, -0.84492129, -0.72499962,
                        -0.60507796, -0.48515629, -0.36523462, -0.24531295, -0.12539129,
                        -0.00546962,  0.11445205,  0.23437371,  0.35429538,  0.47421705,
                         0.59413872,  0.71406038,  0.83398205,  0.95390372,  1.07382539,
                         1.19374705,  1.31366872,  1.43359039,  1.55351206,  1.67343372,
                         1.79335539])
    xy_std = np.array([0.19824439, 0.19132621, 0.18164838, 0.16947241, 0.15525622,
                       0.13961453, 0.12325966, 0.10693215, 0.09133233, 0.07706385,
                       0.06459854, 0.05426833, 0.04628530, 0.04077962, 0.03782896,
                       0.03744940, 0.03956196, 0.04399585, 0.05053919, 0.05898014,
                       0.06910615, 0.08067666, 0.09339314, 0.10688051, 0.12068603,
                       0.13429710, 0.14717584, 0.15880511, 0.16873813, 0.17664306,
                       0.18233469])
    xy_derivative_mean = np.full(xoutput.shape,1.79882501)
    xy_derivative_std = np.array([0.21151528, 0.23622933, 0.26276015, 0.28714624, 0.30591584,
                                  0.31660186, 0.31800232, 0.31027626, 0.29494315, 0.27490346,
                                  0.2547326 , 0.24181409, 0.24979496, 0.31114495, 0.56782978,
                                  0.01344055, 0.59521868, 0.33885795, 0.27409837, 0.25809599,
                                  0.2600433 , 0.26838275, 0.2773624 , 0.2835651 , 0.28484639,
                                  0.28005806, 0.26902949, 0.25258399, 0.23247801, 0.21119234,
                                  0.19150771])
    xy_target = np.vstack((xy_mean,xy_std,xy_derivative_mean,xy_derivative_std))
    xy_lml = 6.41577080575
    xy_null_lml = -739.950926642
