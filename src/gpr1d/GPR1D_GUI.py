...
import matplotlib
old_mpl = packaging.version.Version(matplotlib.__version__) <= packaging.version.Version("2.0.0")
...
fqt5 = packaging.version.Version(pyqtversion) >= packaging.version.Version("5.0.0")
if fqt5:
